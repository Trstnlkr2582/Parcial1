...
import com.desarollo.parcial1.ui.components.detalles
...
fun DetallesScreen(
    ...
    LaunchedEffect(Unit) {
        val detalle = detallesViewModel.obtenerContactos(contactoId)
        if (detalle != null) {
            contacto = detalle
        }
    }
    ...
    )
    {
        Column(
            ...
            contacto?.let { detalles(detallesViewModel, it, navController, contactoId) }
        }
